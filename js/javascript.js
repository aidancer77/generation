...
if (Gpu4_3.checked) GraphGpu4_3.style.display = "flex";
else GraphGpu4_3.style.display = "none";

if (Gpu4_4.checked) GraphGpu4_4.style.display = "flex";
else GraphGpu4_4.style.display = "none";

if (Gpu4_5.checked) GraphGpu4_5.style.display = "flex";
else GraphGpu4_5.style.display = "none";

if (Gpu4_6.checked) GraphGpu4_6.style.display = "flex";
else GraphGpu4_6.style.display = "none";

if (Gpu4_7.checked) GraphGpu4_7.style.display = "flex";
else GraphGpu4_7.style.display = "none";

if (Gpu4_8.checked) GraphGpu4_8.style.display = "flex";
else GraphGpu4_8.style.display = "none";

if (Gpu4_9.checked) GraphGpu4_9.style.display = "flex";
else GraphGpu4_9.style.display = "none";

if (Gpu4_10.checked) GraphGpu4_10.style.display = "flex";
else GraphGpu4_10.style.display = "none";

if (Gpu4_11.checked) GraphGpu4_11.style.display = "flex";
else GraphGpu4_11.style.display = "none";

if (Gpu4_12.checked) GraphGpu4_12.style.display = "flex";
else GraphGpu4_12.style.display = "none";

if (Gpu5_1.checked) GraphGpu5_1.style.display = "flex";
else GraphGpu5_1.style.display = "none";

if (Gpu5_2.checked) GraphGpu5_2.style.display = "flex";
else GraphGpu5_2.style.display = "none";

if (Gpu5_3.checked) GraphGpu5_3.style.display = "flex";
else GraphGpu5_3.style.display = "none";

if (Gpu5_4.checked) GraphGpu5_4.style.display = "flex";
else GraphGpu5_4.style.display = "none";

if (Gpu5_5.checked) GraphGpu5_5.style.display = "flex";
else GraphGpu5_5.style.display = "none";

if (Gpu5_6.checked) GraphGpu5_6.style.display = "flex";
else GraphGpu5_6.style.display = "none";
...
function showOrHide4_1(){
    ...
    if (Gpu4_1.checked) GraphGpu4_1.style.display = "flex";
    else GraphGpu4_1.style.display = "none";
}
...
function showOrHide4_2(){
    ...
    if (Gpu4_2.checked) GraphGpu4_2.style.display = "flex";
    else GraphGpu4_2.style.display = "none";
}
